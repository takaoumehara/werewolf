...
t = {
    "id": "werewolf",
    "color": "dark blood red and deep burgundy", # Monochromatic dark blood red
    "motif": "giant crescent moon obscured by heavy dark swirling clouds, dead tree branches silhouette"
}
...
def main():
    print("Regenerating Werewolf background with a darker, deep wine blood red tone...")
    
    prompt = (
        f"A highly detailed, intricate hand-drawn G-pen style engraving background. "
        f"Colored entirely in a monochromatic color palette of {t['color']} (with only very subtle shifts in value: near-black burgundy shadows and dark wine red highlights). "
