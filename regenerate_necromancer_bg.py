...
t = {
    "id": "necromancer",
    "color": "dark hot pink", # Monochromatic dark hot pink
    "motif": "mystical magic runes, circles, and pink magical spell wisps"
}
...
def main():
    print("Regenerating Necromancer background with a darker magenta/hot pink tone for better contrast...")
    ...
    for try_idx in range(3):
        try:
            ...
            if response.status_code == 200 and res_json.get("code") == 200:
                ...
                print(f"Submitted necromancer_bg: Task ID = {task_id}")
                break
            else:
    ...
    print("\nPolling necromancer background task status...")
    ...
    while True:
        ...
        try:
            ...
            if r.status_code == 200 and res_json.get("code") == 200:
                ...
                print(f"Task necromancer_bg retry status: {status}")
                ...
                if status == "success":
                    ...
                    if url:
                        out_path = os.path.join(BG_DIR, "necromancer_bg.png")
                        print("  Downloading necromancer background...")
                        img_data = requests.get(url, timeout=30).content
                        with open(out_path, 'wb') as f:
                            f.write(img_data)
                        print("  Successfully finished necromancer background.")
                        break
                    else:
                        print("  No URL found.")
                        break
