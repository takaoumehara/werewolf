...
t = {"id": "werewolf", "color": "blood red", "motif": "a giant full crescent moon, dead tree branches, and wild clouds"}
...
def main():
    print("Retrying single failed werewolf background task...")
