...
knights_task = {
    ...
    "shift_pct": 0.15 # Increased to exactly 15% for optimal title text fit
}
...
def process_shift(raw_img_path, shift_pct):
    ...
    # Paste original image shifted down by 15%
...
def main():
    print(f"Adjusting Knights vertical shift to exactly 15%...")
    try:
        ...
        if r.status_code == 200 and r_json.get("code") == 200:
            ...
            if url:
                ...
                print("  Successfully adjusted Knights to 15% shift.")
            else:
